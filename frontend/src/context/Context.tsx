...
//   const [authTokens, setAuthTokens] = useState<AccessTokensType>(() => localStorage.getItem("authTokens")
//       ? JSON.parse(localStorage.getItem("authTokens") || "") : undefined
//   );

//   const [user, setUser] = useState<string | undefined>(() => localStorage.getItem("authTokens")
//       ? jwt_decode(localStorage.getItem("authTokens") || "") : undefined
//   );
...
//     if (authTokens) {
//       axios.post("https://verifyme.up.railway.app/api/token/refresh/", {
...
//       value={{ user, setAuthTokens, setUser, authTokens, setLoading, loading, callLogout, userCreated, setUserCreated, signupWarning, setSignupWarning, }}>
